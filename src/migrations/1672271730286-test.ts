...
export class test1672271730286 implements MigrationInterface {
    name = 'test1672271730286'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_type_enum" AS ENUM('0', '1')`);
